...
- `query: 0 radku` (případně s warningem „EA nerozlišuje 0 řádků od chybného dotazu“) znamená „dotaz nic nevrátil", **ne** „data neexistují" — a **není to chyba** (`E_SQL` je jen skutečné selhání dotazu).
