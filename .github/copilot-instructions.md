...
9. **SQL jen SELECT/WITH**, dialekt **sqlite**; před dotazem ověř názvy sloupců; `rowCount: 0` = „dotaz nic nevrátil", ne „data neexistují" — i chybný název sloupce vrátí `ok` s nulou (a modální dialog v EA).
