...
# (launcher FB_GatekeeperLaunch posila tento kanon powershellu rourou StdIn
#  pres "powershell.exe ... -Command -"; zadny payload na prikazove radce -
#  Norton IDP.HELU.CMD blok z -EncodedCommand, oprava 2026-08-20).
