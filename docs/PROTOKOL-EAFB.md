...
- **Před každým deployem: `node test/harness.js`** (offline sito, mock COM/EA — syntaxe všech `src/` + funkční testy; aktuálně 181/181 PASS). Harness **nenahrazuje** živý E2E: dual-runtime pasti §1a/4 mock nechytí.
