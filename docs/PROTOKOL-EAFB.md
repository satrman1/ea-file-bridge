...
- **Před každým deployem: `node test/harness.js`** (offline sito, mock COM/EA — syntaxe všech `src/` + funkční testy; aktuálně 223/223 PASS, 2026-09-05 Z260904-1c). Harness **nenahrazuje** živý E2E: dual-runtime pasti §1a/4 mock nechytí.
